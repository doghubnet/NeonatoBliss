...
export default function AboutPage() {
  return (
    <main className="section-wrap py-16">
      <h1 className="font-heading text-4xl">About NeonatoBliss</h1>
      <Card className="mt-6">
        <p>
          NeonatoBliss was founded to bridge rigorous infant science and everyday parenting reality. Rooted in Ethiopia and
